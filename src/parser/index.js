...
function parse(url, lang) {
    ...
    var parser = parsers_1["default"].find(function (p) { return url.match(p.pattern); });
    if (parser) {
...
function startFromCommandLine() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, parse(process.argv[2], process.argv[3] || 'fi')];
                case 1:
                    menu = _a.sent();
                    console.log(util_1.inspect(menu, null, null));
                    return [2 /*return*/];
            }
        });
    });
